...
import com.example.helpmyplsnaxyu.Adapter.NewPostAdapter;
import com.example.helpmyplsnaxyu.Adapter.ToDoAdapter;
import com.example.helpmyplsnaxyu.Models.Post;
import com.example.helpmyplsnaxyu.Models.ToDoModel;
import com.example.helpmyplsnaxyu.Models.User;
import com.example.helpmyplsnaxyu.Utils.DatabaseHandler;
...
public class Main extends AppCompatActivity implements DialogCloseListener{
    ...
    //save
    Button bbtnAdd, bbtnRead, bbtnClear;
    EditText etName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bbtnAdd = (Button) findViewById(R.id.bbtnAdd);
        bbtnAdd.setOnClickListener((View.OnClickListener) this);

        bbtnRead = (Button) findViewById(R.id.bbtnRead);
        bbtnRead.setOnClickListener((View.OnClickListener) this);

        bbtnClear = (Button) findViewById(R.id.bbtnClear);
        bbtnClear.setOnClickListener((View.OnClickListener) this);
    ...
    {nameProfile.setText(loadText("userName",sPref));
       ...
       Log.e("Profile","Start");
        if (rc != null) {
            ...
            dbnewpost.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
...
{Log.e("Profile2",String.valueOf(countprofile));
    ...
    public void Save_FP(RecyclerView rc1, FloatingActionButton fab1){
    ...
    public void new_page(ImageView bad, ImageView good, ImageView excellent, LinearLayout insideLayout) {
    }
}