...
public class Main extends AppCompatActivity implements DialogCloseListener{
    ...
    public void new_page(ImageView bad1, ImageView well1, ImageView good1, ImageView excellent1, LinearLayout insideLayout1){
        ...
        dialog.setMessage("Хочешь поделиться этим с друзьями?");
        ...
        bad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setTitle("Нам очень жаль, что у тебя плохое настроение...");

                insideLayout.removeAllViews();
                dialog.show();
                textView.setText("Нам очень жаль, что у тебя плохое настроение...Хочешь поделиться этим с друзьями?");
                    }
